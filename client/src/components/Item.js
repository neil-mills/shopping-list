    ...
    return (
      <li className="item">
        ...
        <span>
          ...
          <select
            className={classNames('select',{'select--error': isError('categoryId')})}
            name="categoryId[]"
        ...
        <span>
          <select
            className={classNames('select',{'select--error': isError('brandId')})}
            name="brandId[]"
            id={`brandId_${index}`}
            onChange={handleChange}
            value={item.brandId}
        ...
        <span>
          <select
            className={classNames('select',{'select--error': isError('unitId')})}
            name="unitId[]"
            id={`unitId_${index}`}
            onChange={handleChange}
            value={item.unitId}
